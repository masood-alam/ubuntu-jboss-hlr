...
docker run  --name ubuntu-jboss-hlr --net mynet123 --ip 172.18.0.2 -v /home/masood/docker/ubuntu-jboss-hlr/data:/opt/jboss-5.1.0.GA-networkside/server/default/data -v /home/masood/docker/ubuntu-jboss-hlr/data:/opt/jboss-5.1.0.GA-networkside/server/default/log -d ubuntu-jboss-hlr
